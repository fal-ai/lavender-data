...
from lavender_data.server.cache import get_client, setup_redis
...
class TestIterationState(unittest.TestCase):
    def setUp(self):
        ...
        setup_redis(os.getenv("LAVENDER_DATA_REDIS_URL", "redis://localhost:6379/0"))
        self.cache = next(get_client())
