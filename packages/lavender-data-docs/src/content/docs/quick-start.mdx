...
2. Start the lavender-data server. [details](/server/configuration)
...
3. Create the dataset. [details](/dataset/structure)
...
4. Create the shardset. [details](/dataset/shardsets)
...
6. Iterate over the dataset. [details](/dataloader/progress)
